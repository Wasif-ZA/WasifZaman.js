// Single source for the canonical origin. It was previously repeated in
// layout.tsx, sitemap.ts and robots.ts, which is three places to miss on a
// domain change.
export const SITE_URL = "https://www.wasifzaman.tech";
